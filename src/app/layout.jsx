...
export const metadata = {
  ...
  openGraph: {
    ...
    description:
      "Transform your digital vision with innovative software solutions. Web development, mobile apps, and enterprise solutions that drive business growth.",
    images: [
      {
        url: "/og-image.png",
        width: 1200,
  ...
  twitter: {
    ...
    title: "AppitSoftware - Leading Software Development Company",
    description:
      "Transform your digital vision with innovative software solutions. Web development, mobile apps, and enterprise solutions.",
...
export default function RootLayout({ children }) {
  return (
    <html
      lang="en"
      className={`${inter.variable} ${poppins.variable} ${jost.variable}`}
    >
      <head>
        ...
        <meta
          ...
          content="UGcbYI5b5x_t_XJfzAtRZ8xv7NQmDx-5QYI0q5o-zxM"
        />
        {/* Google tag (gtag.js) */}
        <Script
        ...
        <script
          ...
          dangerouslySetInnerHTML={{
            __html: JSON.stringify({
              ...
              name: "AppitSoftware",
              description:
                "Leading software development company specializing in web applications, mobile apps, and enterprise solutions.",
              url: "/",
              logo: "/logo.png",
              contactPoint: {
                "@type": "ContactPoint",
