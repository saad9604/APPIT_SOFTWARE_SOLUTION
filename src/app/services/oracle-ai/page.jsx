...
export const metadata = {
  ...
  description:
    "APPIT Software's Oracle AI solutions and business operations are designed to streamline workflows and deliver real-time insights.",
  keywords: [
    "Oracle AI Solutions",
      ...
      <Script
        ...
        dangerouslySetInnerHTML={{
          __html: JSON.stringify({
            ...
            "@id": "WebPage",
            acquireLicensePage:
              "https://www.appitsoftware.com/oracle-ai-solutions/",
          }),
        }}
      />
      <Script
