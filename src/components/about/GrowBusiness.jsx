...
const GrowBusiness = () => {
  ...
  return (
    <section
      ref={sectionRef}
      className="pt-24 md:pt-28 lg:pt-32 pb-0 px-6 sm:px-12 md:px-16 lg:px-24 overflow-hidden bg-white"
    >
      <div className="container mx-auto max-w-[1400px] px-4">
        <div className="relative">
          ...
          <div className="flex flex-col lg:flex-row gap-10 lg:gap-16 items-start mb-14 sm:mb-20 lg:mb-24">
            ...
            <div className="flex flex-col items-start gap-7 w-full lg:w-[47%]">
              {/* Heading */}
              <h2
                className={`text-3xl md:text-4xl text-[#252525] font-semibold font-['Jost'] leading-[120%] transition-all duration-700 ease-out ${
                  isVisible
                    ? "opacity-100 translate-y-0"
                    : "opacity-0 translate-y-8"
                }`}
              >
                <span className="text-[#EC1C26]">Grow</span> your Business &
                Customer Satisfaction with{" "}
                <span className="text-[#EC1C26]">APPIT</span>
              </h2>

              {/* Paragraph */}
              <p
                className={`text-lg md:text-xl lg:text-[21px] font-normal font-['Jost'] leading-[130%] transition-all duration-700 ease-out ${
                  isVisible
                    ? "opacity-100 translate-y-0"
                    : "opacity-0 translate-y-8"
                }`}
              ...
              >
                APPIT Software aims to deliver IT Services & Business Solutions
                that exceed the client's expectations. It is possible only when
                we update ourselves to agile and innovative IT solutions that
                can serve value to the business.
              </p>
            </div>

            {/* Right side: Image with logo and cropped shape */}
            <div
              className={`relative w-full lg:w-[53%] h-[320px] sm:h-[370px] md:h-[420px] lg:h-[480px] mt-4 lg:mt-0 transition-all duration-700 ease-out ${
          ...
          <div
            className="absolute w-full left-0 bottom-0 z-20 hidden lg:block"
            style={{ transform: "translateY(29%)" }}
          >
              ...
              <div className="relative w-full">
                ...
                >
                  {timelineData.map((item, index) => (
                    ...
                    >
                      <div
                        className="h-[61px] w-full overflow-hidden"
                        style={{
                          borderRadius: "24px",
        ...
        <div className="block lg:hidden -mt-2 mb-16">
          <h4 className="text-xl font-semibold font-['Jost'] mb-2 md:text-center">
            Our Journey
          </h4>
            ...
            {timelineData.map((item, index) => (
              <div
                ...
                style={{
                  opacity: activeIndex >= index ? 1 : 0,
                  transform:
                    activeIndex >= index ? "translateY(0)" : "translateY(30px)",
              ...
              >
                ...
                <div className="flex flex-col items-center">
                  ...
                  <h4 className="font-semibold text-sm text-center font-['Jost'] max-w-[180px]">
                    {item.description}
                  </h4>
                </div>
              </div>
