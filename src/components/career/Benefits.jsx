  ...
  const benefitsData = [
    {
      icon: (
        ...
        >
          <g>
            ...
            >
              <path
                d="M20 28.5C24.4184 28.5 28 24.9184 28 20.5C28 16.0816 24.4184 12.5 20 12.5C15.5816 12.5 12 16.0816 12 20.5C12 24.9184 15.5816 28.5 20 28.5Z"
                fill="white"
                stroke="white"
                strokeWidth="2"
              ...
              />
              <path
                d="M20.0029 15.7V20.504L23.3945 23.896"
                stroke="black"
                strokeWidth="2"
                strokeLinecap="round"
                strokeLinejoin="round"
            ...
            <g mask="url(#mask0_893_4536)">
              <path
                d="M10.4004 10.8999H29.6004V30.0999H10.4004V10.8999Z"
                fill="black"
              />
            </g>
          </g>
      ...
      description:
        "Hybrid work models, flexible hours, and a focus on work-life balance to help you do your best work—on your terms.",
    },
    {
      icon: (
        <svg
      ...
      description:
        "Attractive salary packages with performance-based incentives and bonuses.",
    },
    {
      icon: (
        <svg
      ...
      description:
        "Clear career paths, leadership training, and chances to work on impactful, global projects.",
    },
    {
      icon: (
        <svg
      ...
      description:
        "Regular team outings, festive events, and employee recognition programs to keep the culture vibrant and engaging.",
    },
    {
      icon: (
        <svg
      ...
      description:
        "Comprehensive health insurance plans, wellness programs, and mental health support.",
    },
    {
      icon: (
        <svg
      ...
      description:
        "Be part of AI, cloud, and enterprise-grade software innovations that challenge and grow your expertise.",
    },
  ];
          ...
          if (entry.isIntersecting) {
            ...
            if (headingRef.current) {
              ...
              headingRef.current.style.transition =
                "opacity 1.2s cubic-bezier(0.19, 1, 0.22, 1), transform 1.5s cubic-bezier(0.19, 1, 0.22, 1)";
    ...
    >
      <div className="max-w-[1240px] mx-auto flex flex-col items-center gap-5 sm:gap-6 md:gap-8 lg:gap-10">
        ...
        <div className="flex flex-col items-center gap-1 xs:gap-2 sm:gap-4 w-full">
          <h2
            ref={headingRef}
            className="text-[24px] text-[#252525] xs:text-[28px] sm:text-[32px] md:text-[36px] lg:text-[40px] font-semibold leading-[120%] font-['Jost'] text-center transition-all duration-1500 ease-in-out"
          ...
          <p
            ...
            style={{ opacity: 0, transform: "translateY(30px)" }}
          >
            At APPIT, we believe great work begins with a great workplace.
            That's why we offer a range of benefits designed to support your
            personal well-being, professional growth, and overall success.
          </p>
        </div>
        ...
        <div className="w-full flex flex-wrap justify-center gap-y-2 xs:gap-y-3 sm:gap-y-4 gap-x-4 xs:gap-x-5 sm:gap-x-6 md:gap-x-8 lg:gap-x-10">
          {benefitsData.map((benefit, index) => (
            <div
              ...
              style={{
                background:
                  "linear-gradient(80deg, #00264D -12.08%, #005299 111.68%)",
                opacity: 0,
