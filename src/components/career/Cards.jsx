...
const Cards = () => {
  ...
  useEffect(() => {
    ...
    axios
      .get("https://appit-backend-wb0d.onrender.com/get-jobs")
  ...
  return (
    ...
    >
      <div className="max-w-[1240px] mx-auto flex flex-col items-center gap-6 sm:gap-8 md:gap-10">
        <h2
          ref={headingRef}
          className="w-full text-[#252525] text-center text-xl sm:text-2xl md:text-[32px] font-semibold leading-[120%] font-['Jost'] transition-all duration-500 ease-out"
            ...
            >
              <div className="w-full flex flex-row justify-between items-start gap-4">
                <div className="flex flex-col items-start gap-2 sm:gap-2.5">
                  <h3 className="text-lg sm:text-xl md:text-[21px] font-semibold leading-[120%] font-['Jost'] text-black">
                    {job.title}
                  </h3>
                  <p className="text-base sm:text-[16px] font-semibold leading-[120%] font-['Jost'] text-[#252525]">
                    {job.company}
                  </p>
                  ...
                  <div className="flex flex-col sm:flex-row items-start sm:items-center gap-3 sm:gap-6">
                    <div className="flex items-center gap-2">
                      ...
                      <span className="text-sm sm:text-base font-normal leading-[120%] font-['Jost'] text-[#454545]">
                        4-9yrs
                      </span>
                    </div>
