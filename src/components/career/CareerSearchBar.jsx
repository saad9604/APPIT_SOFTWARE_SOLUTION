  ...
  const removeFilter = (type, value) => {
    setFilters((prev) => {
      ...
      if (type === "jobType") {
        ...
        newFilters.experienceLevel = prev.experienceLevel.filter(
          (item) => item !== value
        );
      }
  ...
  return (
    <section className="w-full bg-[#FFFF] py-10 sm:py-10 md:py-12 pb-8 sm:pb-8 md:pb-8 px-4 sm:px-6 lg:px-8">
      <div className="flex flex-col items-center justify-center max-w-4xl mx-auto gap-6 sm:gap-8 md:gap-10">
        {/* Heading */}
        <h2 className="text-cente text-[#252525] font-jost text-3xl sm:text-4xl md:text-[40px] lg:text-[48px] font-semibold leading-[120%] w-full">
