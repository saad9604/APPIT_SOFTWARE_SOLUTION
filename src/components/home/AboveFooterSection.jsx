    ...
    >
      ...
      <div className="max-w-[1440px] mx-auto flex flex-col items-start w-full px-0 sm:px-4 md:px-[60px] lg:px-[120px]">
            ...
            <div className="flex flex-wrap justify-start sm:justify-between items-center w-full gap-4 sm:gap-5 mb-8 sm:mb-12 md:mb-16">
              ...
              >
                <div className="w-8 h-8 sm:w-10 sm:h-10 aspect-square">
                  ...
                  >
                    <path
                      d="M23.3333 22.5002H27.5L29.1666 15.8335H23.3333V12.5002C23.3333 10.7835 23.3333 9.16683 26.6666 9.16683H29.1666V3.56683C28.6233 3.49516 26.5716 3.3335 24.405 3.3335C19.88 3.3335 16.6666 6.09516 16.6666 11.1668V15.8335H11.6666V22.5002H16.6666V36.6668H23.3333V22.5002Z"
                      fill="black"
                    />
                  </svg>
                </div>
              ...
              >
                <div className="w-8 h-8 sm:w-10 sm:h-10 aspect-square">
                  ...
                  >
                    <path
                      d="M23.485 17.32L36.1425 2.5H33.1425L22.155 15.3675L13.375 2.5H3.25L16.525 21.96L3.25 37.5H6.25L17.855 23.91L27.1275 37.5H37.2525L23.485 17.32ZM19.3775 22.13L18.0325 20.1925L7.33 4.775H11.9375L20.5725 17.2175L21.9175 19.155L33.145 35.33H28.5375L19.3775 22.13Z"
                      fill="black"
                    />
                  </svg>
                </div>
        ...
        <div className="w-full mb-6 sm:mb-8 md:mb-10">
          <h2 className="text-[#252525] text-xl sm:text-2xl md:text-3xl font-bold mb-4 sm:mb-6 md:mb-8">
            Quick links
          </h2>
        ...
        <div className="grid grid-cols-1 sm:grid-cols-2 lg:grid-cols-4 gap-4 sm:gap-6 w-full">
          ...
          <div className="flex items-start gap-3 min-w-0 break-words">
            ...
            <p className="text-black text-xs sm:text-sm leading-tight">
              IND: PSR Prime Towers, 704 C, 7th Floor, Adjacent to DLF Cyber
              City, Gachibowli, Hyderabad, Telangana, India-500032
            </p>
          </div>
          ...
          <div className="flex items-start gap-3 min-w-0 break-words">
            <img
              src="/images/uae.png"
              alt="UAE Flag"
              className="w-8 h-4 sm:w-10 sm:h-5 object-cover"
            />
            <p className="text-black text-xs sm:text-sm leading-tight">
              UAE: IFZA Business Park, DDPDubai Silicon Oasis, DDP, Building A1,
          ...
          <div className="flex items-start gap-3 min-w-0 break-words">
            <img
              src="/images/usa.png"
              alt="USA Flag"
              className="w-8 h-4 sm:w-10 sm:h-[21px] object-cover"
            />
            <p className="text-black text-xs sm:text-sm leading-tight">
          ...
          <div className="flex items-start gap-3 min-w-0 break-words">
            <img
              ...
              className="w-8 h-5 sm:w-10 sm:h-[27px] object-cover"
            />
            <p className="text-black text-xs sm:text-sm leading-tight">
