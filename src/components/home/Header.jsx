      ...
      <div className="w-full flex justify-center">
        <div className="w-full max-w-[1440px] px-4 sm:px-[30px] md:px-[60px] py-[16px] flex justify-between items-center">
          ...
          >
            ...
            <Link
              href="/career"
              className="py-[10px] px-[8px] text-[#000] text-[17px] lg:text-[21px] font-bold leading-[120%] font-jost transition-colors duration-300 hover:text-[#C7131A] flex justify-center items-center"
            >
              Career
            </Link>
            <Link
            ...
            >
              ...
              >
                ...
                <div className="relative flex flex-col gap-[6px] items-start">
                  {/* Top bar - largest */}
                  <div
                    className={`h-[4px] w-[38px] bg-[#003366] rounded-full transform-gpu transition-all duration-300 ${
                  ...
                  {/* Bottom bar - smallest */}
                  <div
                    className={`h-[4px] w-[18px] bg-[#003366] rounded-full transform-gpu transition-all duration-300 ${
