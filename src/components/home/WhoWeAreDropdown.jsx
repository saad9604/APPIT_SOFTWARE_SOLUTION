...
export default function WhoWeAreDropdown({
  isOpen,
  onClose,
  isMobile = false,
}) {
    ...
    <div className="grid grid-cols-1 md:grid-cols-2 gap-6 w-full h-full">
      ...
      >
        <p className="w-full font-['Jost'] text-[16px] leading-[120%] text-black">
          APPIT Software aims to deliver IT Services & Business Solutions that
          exceed the client's expectations. It is possible only when we update
          ourselves to agile and innovative IT solutions that can serve value to
          the business.
        </p>
        <div>
    ...
    <div className="flex flex-col gap-6 w-full">
      <div className="w-full md:w-[713px]">
        ...
        <p className="font-['Jost'] text-[16px] leading-[120%] text-black">
          Dive into expert insights, industry trends, and thought leadership
          across AI, legal tech, cloud solutions, and enterprise transformation.
          The Appit Blog is your go-to resource for staying ahead in the rapidly
    ...
    <div className="flex flex-col gap-6 w-full">
      <div className="flex flex-col gap-4">
        ...
        <p className="w-full md:w-[672px] font-['Jost'] text-[16px] leading-[120%] text-black">
          A diverse group of visionaries, engineers, and strategists dedicated
          to building intelligent, scalable solutions that transform businesses.
        </p>
      </div>
      <div>
      ...
      >
        <div className="bg-white shadow rounded-lg overflow-hidden">
          <div className="p-4 border-b">
            <h3 className="text-lg font-semibold text-[#055087]">Who We Are</h3>
          </div>
      ...
      <div className="w-full mx-auto py-2.5 flex-col justify-center items-center">
        ...
        >
          ...
          <div className="flex flex-col md:flex-row px-[10px] items-center gap-[24px] self-stretch pb-[20px]">
            ...
            <div className="flex w-full md:w-[300px] py-[16px] pb-[20px] flex-col items-center self-stretch bg-[#055087]">
              {sidebarTabs.map((tab) => (
                <div
                  key={tab}
                  onClick={(e) => handleTabClick(tab, e)}
