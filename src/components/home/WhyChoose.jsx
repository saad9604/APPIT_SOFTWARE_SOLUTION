  ...
  return (
    ...
    >
      ...
      <div className="w-full max-w-[1152px] flex flex-col items-center gap-4 sm:gap-5 md:gap-[20px]">
        <h2
          className={`text-center text-3xl sm:text-4xl md:text-5xl lg:text-[50px] font-semibold leading-[120%] m-0 transition-all duration-500 ease-out ${
            isInView ? "opacity-100 translate-y-0" : "opacity-0 translate-y-8"
          }`}
        >
          <span className="text-[#EC1C26] lg:text-[50px] lg:font-semibold lg:leading-[120%]">
            Why Choose
          </span>{" "}
          <span className="text-[#252525] sm:inline md:inline lg:inline lg:text-[50px] lg:font-semibold lg:leading-[120%]">
            APPIT Software
          </span>
          <span className="text-[#252525] sm:inline md:inline lg:inline lg:text-[50px] lg:font-semibold lg:leading-[120%]">
            {" "}
          ...
          <span className="text-[#252525] sm:inline md:inline lg:inline whitespace-nowrap lg:text-[50px] lg:font-semibold lg:leading-[120%]">
            {" "}
            ?
          </span>
        </h2>
        <p
          className={`w-full text-center text-[#000] text-lg sm:text-xl md:text-2xl lg:text-[21px] font-semibold leading-[120%] m-0 transition-all duration-500 ease-out ${
            isInView ? "opacity-100 translate-y-0" : "opacity-0 translate-y-8"
          }`}
          style={{ transitionDelay: "0.2s" }}
        >
          We solve your most complex technology challenges with innovative,
          scalable solutions. From strategy to execution, we transform your
          digital ecosystem to unlock new growth.
        </p>
      </div>
      ...
      <div className="w-full max-w-[1200px] 2xl:max-w-[1250px] flex justify-center flex-wrap gap-4 lg:gap-6 xl:gap-[20px] px-1 sm:px-2 md:px-4 lg:px-8 card-container">
        ...
        >
          ...
          >
            <p className="text-white text-center text-base xs:text-lg sm:text-xl md:text-xl lg:text-[21px] font-normal leading-[120%] m-0 px-2 xs:px-4 sm:px-6 lg:self-stretch lg:font-normal lg:mt-auto lg:mb-auto">
              With over 9+ years of hands-on experience in AI development and
              deployment, we have consistently delivered successful
              solutions—demonstrating the expertise and reliability needed to
              power your business's AI journey.
            </p>
          </div>
        ...
        <div
          ...
          style={{
            backgroundImage:
              "linear-gradient(0deg, rgba(0, 0, 0, 0.05) 0%, rgba(0, 0, 0, 0.05) 100%), url(/images/second_card.jpg)",
        ...
        >
          ...
          >
            <p className="text-[#252525] text-center text-base xs:text-lg sm:text-xl md:text-xl lg:text-[21px] font-normal leading-[120%] m-0 px-2 xs:px-4 sm:px-6 lg:self-stretch lg:font-normal lg:mt-auto lg:mb-auto">
              Employing over 150+ individuals, we offer a broad range of skills
              and knowledge to support your business's AI requirements,
              providing a comprehensive solution to meet your needs
            </p>
          </div>
        ...
        <div
          ...
          style={{
            backgroundImage:
              "linear-gradient(0deg, rgba(0, 0, 0, 0.05) 0%, rgba(0, 0, 0, 0.05) 100%), url(/images/third_card.jpg)",
        ...
        >
          ...
          >
            <p className="text-white text-center text-base xs:text-lg sm:text-xl md:text-xl lg:text-[21px] font-normal leading-[120%] m-0 px-2 xs:px-4 sm:px-6 lg:self-stretch lg:font-normal lg:mt-auto lg:mb-auto">
              We believe people are at the heart of innovation. Backed by years
              of AI development and implementation experience, our team combines
              technical expertise with a human-centric approach to deliver
              impactful, tailored AI solutions for your business.
            </p>
          </div>
        ...
        <div
          ...
          style={{
            backgroundImage:
              "linear-gradient(0deg, rgba(0, 0, 0, 0.20) 0%, rgba(0, 0, 0, 0.20) 100%), url(/images/fourth_card.jpg)",
        ...
        >
          ...
          >
            <p className="text-white text-center text-base xs:text-lg sm:text-xl md:text-xl lg:text-[21px] font-normal leading-[120%] m-0 px-2 xs:px-4 sm:px-6 lg:self-stretch lg:font-normal lg:mt-auto lg:mb-auto">
              We prioritize our employees' growth and development, ensuring a
              dedicated and motivated team that is committed to delivering the
              best AI solutions for your business.
            </p>
          </div>
