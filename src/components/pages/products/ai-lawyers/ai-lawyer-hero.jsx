    ...
    >
      <div className="w-full pt-24 md:pt-32 xl:pt-36">
        <Container>
          <HeadingPara
            title="AI Lawyer"
            para="Say goodbye to routine legal tasks. AI Lawyer automates research, document drafting, and administrative work—giving you more time to focus on what matters most."
