...
const PartnershipBenefits = () => {
  ...
  return (
    <section
      ref={sectionRef}
      className="w-full bg-white py-12 xs:py-14 sm:py-16 md:py-20"
    >
      <div className="mx-auto flex flex-col gap-16 max-w-[1241px] w-full px-3 xs:px-4 sm:px-6 md:px-8 lg:px-10 overflow-visible pt-0">
        ...
        <div className="flex flex-col md:flex-row gap-6 md:gap-8 lg:gap-16 w-full items-center">
          ...
          <div className="w-full md:w-1/2 lg:w-[750px] flex flex-col gap-4 order-2 md:order-1">
            ...
            <p className="text-black font-jost text-lg md:text-[21px] font-normal leading-[115%]">
              Collaborating with an official Odoo partner like AppitSoftware
              ...
              possesses in-depth knowledge of Odoo's functionalities, ensuring
              efficient and effective implementation.​
              <br />
              <span className="font-medium">Customized Solutions:</span> We
              tailor Odoo modules to align with specific business processes,
              providing a personalized ERP experience.​
              <br />
              <span className="font-medium">Ongoing Support:</span>{" "}
              AppitSoftware offers continuous support and maintenance, ensuring
              that your ERP system evolves with your business needs.​
              <br />
              <span className="font-medium">Training and Education:</span> We
              provide comprehensive training to empower your team to utilize
              Odoo's features fully.​
              <br />
              <span className="font-medium">Integration Capabilities:</span> Our
              expertise extends to integrating Odoo with other systems,
              facilitating seamless data flow across your organization.​
              <br />
              By choosing AppitSoftware as your Odoo partner, you invest in a
              collaborative relationship aimed at achieving operational
        ...
        <div className="flex flex-col md:flex-row gap-6 md:gap-8 lg:gap-16 w-full items-center">
          ...
          <div className="w-full md:w-1/2 lg:w-[750px] flex flex-col gap-4 order-2 md:order-1">
            ...
            <p className="text-black font-jost text-lg md:text-[21px] font-normal leading-[115%]">
              As we look ahead to 2025, BrowseInfo emerges as a leading Odoo
              partner in India, recognized for its innovative solutions and
              customer-centric approach. With a track record of successful Odoo
              implementations across various industries, BrowseInfo has
              demonstrated excellence in delivering ERP solutions that drive
              business transformation.​
              <br />
              Their commitment to staying abreast of technological advancements
              ensures that clients benefit from the latest features and
              enhancements in Odoo. By focusing on quality, reliability, and
              customer satisfaction, BrowseInfo sets the benchmark for Odoo
              partnership services in India.​
            </p>
          </div>
        </div>
        ...
        <div className="flex flex-col lg:flex-row gap-0 w-full items-start mb-12 overflow-visible relative lg:min-h-[500px]">
          ...
          <div className="w-full lg:w-[500px] px-2 lg:ml-6 flex flex-col gap-4">
            <h3 className="text-black font-jost text-2xl md:text-[27px] font-semibold leading-[120%]">
              <span className="text-[#EC1C26]">Why Choose</span> Odoo & Appit
              Software Solutions?
            </h3>
            <p className="text-black font-jost text-lg md:text-[21px] font-normal leading-[115%]">
              As a trusted Odoo partner, Appit Software delivers tailored ERP
              solutions that fit your business needs. We handle everything from
              implementation and customization to ongoing support and training,
              making sure your system runs smoothly and grows with you. Our
              expert team combines deep industry knowledge with technical
              expertise to create solutions that streamline operations, improve
              productivity, and reduce manual effort. Whether you're a small
              startup or an established enterprise, and whether you need a
              fully-customized solution or third-party tools, we ensure a
              seamless experience from start to finish. With scalable and
              flexible Odoo ERP solutions, we help your business adapt to
              changing market demands and achieve business success.
            </p>
          </div>
          {/* Form Container */}

          <div className="w-full lg:w-[600px] sm:p-6 md:p-8 lg:p-10 flex flex-col items-center gap-6 rounded-[32px] bg-white z-10 lg:absolute lg:right-[-40px] lg:top-0 mt-10 sm:mt-14 md:mt-16 lg:mt-0">
            <UMForm isHeadPara />
          </div>
